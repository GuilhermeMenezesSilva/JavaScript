...
var Pessoa = /*#__PURE__*/function () {
  ...
  return _createClass(Pessoa, [{
    ...
    value: function falar() {
      console.log("Meu nome \xE9 ".concat(this.nome, " ").concat(this.sobrenome));
    }
  }]);
}();
...
var p1 = new _modulo1_js__WEBPACK_IMPORTED_MODULE_0__["default"]('João', 'Silva');
p1.falar();
...
console.log((0,_modulo1_js__WEBPACK_IMPORTED_MODULE_0__.soma)(5, 10));
})();
